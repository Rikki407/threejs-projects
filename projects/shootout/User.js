...
class User {
    ...
    initRifleDirection() {
        ...
        this.rifleDirection.firing = new Quaternion(
            -0.054,
            -0.75,
            0.633,
            -0.184
        ...
        this.rifleDirection.shot = new Quaternion(
            -0.082,
            -0.789,
            0.594,
            -0.138
    ...
    initMouseHandler() {
        ...
        function raycast(e) {
            ...
            const intersects = self.raycaster.intersectObject(
                self.game.navmesh
            );
    ...
    update(dt) {
        ...
        if (this.isFiring) {
            const elapsedTime =
                this.game.clock.getElapsedTime() - this.bulletTime;
