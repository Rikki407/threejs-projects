...
function boxIntersectsCylinder(
    minx,
    miny,
    minz,
    maxx,
...
function sphereIntersectsBox(
    ...
    var result = boxIntersectsSphere(
        minx,
        miny,
        minz,
        maxx,
...
function cylinderIntersectsBox(
    cx,
    cy,
    cz,
    ch,
    ...
    var result = boxIntersectsCylinder(
        minx,
        miny,
        minz,
        maxx,
